...
You can put a catpcha inside a cell view just like in normal view. Just remember to use validates_captcha both in the cell and in the controller where the cell in used. Validation must be done in the controller.
